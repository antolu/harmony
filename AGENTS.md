...
- `middlewares.py` - SafetyMiddleware, DomainRouterMiddleware, DeltaFetchMiddleware, AuthMiddleware
- `auth/` - Authentication system (providers, registry, middleware, CLI)
...
2. AuthMiddleware applies credentials (priority 50), retries on 401/403
