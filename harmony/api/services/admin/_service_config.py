...
class ServiceConfigStore:
    ...
    DEFAULTS: typing.ClassVar[dict[str, str]] = {
        ...
        "pipeline_search_content_token_budget": "8000",
    ...
    DESCRIPTIONS: typing.ClassVar[dict[str, str]] = {
        ...
        "pipeline_search_content_token_budget": "Shared token budget for document content across all search_documents results (approx; front-loads strongest hits, truncated docs recoverable via get_document_details)",
    ...
    _ENV_MAP: typing.ClassVar[dict[str, str]] = {
        ...
        "pipeline_search_content_token_budget": "PIPELINE_SEARCH_CONTENT_TOKEN_BUDGET",
