...
def test_feedback_router_importable() -> None:
    from harmony.api.routes._feedback import router  # type: ignore[import]
...
def test_feedback_request_validates_rating_up_or_down() -> None:
    from harmony.api.routes._feedback import FeedbackRequest  # type: ignore[import]
...
def test_preferences_router_importable() -> None:
    from harmony.api.routes._preferences import router  # type: ignore[import]
...
def test_preferences_update_accepts_valid_theme() -> None:
    from harmony.api.routes._preferences import (
        PreferencesUpdate,  # type: ignore[import]
    )
