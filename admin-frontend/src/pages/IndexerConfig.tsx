...
export function IndexerConfig() {
  ...
  const handleImport = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      const response = await fetch(`/api/configs/indexer/import?name=${file.name.replace('.yaml', '').replace('.yml', '')}`, {
        method: 'POST',
        body: formData,
      })
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-3xl font-bold tracking-tight">Indexer Configuration</h2>
              ...
              <AlertDialog>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      Are you sure you want to delete "{selectedIndexerConfig}"? This cannot be undone.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
                    <AlertDialogCancel>Cancel</AlertDialogCancel>
      ...
      {/* Config Form */}
      {selectedIndexerConfig && !configLoading && (
        <Tabs defaultValue="form">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex gap-2">
              <Button onClick={() => saveMutation.mutate()} disabled={saveMutation.isPending || !!yamlError}>
                {saveMutation.isPending ? 'Saving...' : 'Save'}
              </Button>
              <Button onClick={() => runMutation.mutate()} disabled={runMutation.isPending || !!yamlError} variant="secondary">
          ...
          <TabsContent value="form" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Where to read crawled data from</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    placeholder="output"
                  />
                  <p className="text-xs text-muted-foreground">Directory containing crawled files</p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem value="disk">Disk (metadata.jsonl)</SelectItem>
                      <SelectItem value="elasticsearch">Elasticsearch State</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => updateConfig('state_index', e.target.value)}
                  />
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Target Elasticsearch settings</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  <Label>ES Host</Label>
                  <Input
                    ...
                    onChange={(e) => updateConfig('es_host', e.target.value)}
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => updateConfig('index_base_name', e.target.value)}
                    placeholder="harmony"
                  />
                  <p className="text-xs text-muted-foreground">Indices will be named: base-language (e.g., harmony-en)</p>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Delete documents missing from crawl state</p>
                  </div>
                  <Switch
                    checked={config.sync_deletions as boolean || false}
                    onCheckedChange={(v) => updateConfig('sync_deletions', v)}
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => updateConfig('missing_threshold', parseInt(e.target.value))}
                  />
                  <p className="text-xs text-muted-foreground">Number of crawls before deletion</p>
                </div>
              </CardContent>
            </Card>
          </TabsContent>
